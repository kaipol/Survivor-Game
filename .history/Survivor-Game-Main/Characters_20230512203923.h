...
public:
    bullet(int attack, QPixmap *bullet_pic, QPair<int, int> bullet_loc) : attack(attack), bullet_pic(bullet_pic), bullet_loc(bullet_loc) {}
    QPixmap *get_bullet_pic() { return bullet_pic; } // 获取子弹图片
};
