...
Heroes::Heroes(QString name1)
{
    ...
    else if (name1 == "NOA")
    {
        ...
        hero_bullets = new QPixmap("../src/Sprite/NOA-bullet.png");
    }
    exp = 0;
    level = 1;
    revival_times = 0;
...
{
    name = hero_mir.name;
    hero_hp_label = hero_mir.hero_hp_label;
    ...
    hero_pic = hero_mir.hero_pic;
    hero_bullets = hero_mir.hero_bullets;
}
