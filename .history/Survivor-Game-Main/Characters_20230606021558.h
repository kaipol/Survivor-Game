...
protected:
    ...
    virtual void set_blood_max(int) = 0;
...
public:
    ...
    int get_blood_max() override;         // 获取英雄最大血量
    ...
    void set_blood_max(int) override;     // 设置英雄最大血量
...
public:
    ...
    int get_blood_max() override;         // 获取怪物最大血量
    ...
    void set_blood_max(int) override;     // 设置怪物最大血量
    ...
    QPair<int, int> get_pic_size();    // 获取怪物图片大小
};
