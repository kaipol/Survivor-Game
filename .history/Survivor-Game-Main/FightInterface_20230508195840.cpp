...
void FightInterface::game_over()
{
    ...
    QPushButton *game_over_button = new QPushButton("退出", game_over_widget);
    connect(game_over_button, &QPushButton::clicked, this, &FightInterface::back_to_main);
    game_over_button->setGeometry(100, 100, 100, 50);
    QLabel *game_over_label = new QLabel("游戏胜利", game_over_widget);
