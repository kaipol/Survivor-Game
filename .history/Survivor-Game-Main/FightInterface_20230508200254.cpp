...
void FightInterface::game_over(int type)
{
    ...
    if (type == 0)
        QLabel *game_over_label = new QLabel("恭喜你,游戏胜利!", game_over_widget);
    else if (type == 1)
        QLabel *game_over_label = new QLabel("很遗憾,游戏失败!", game_over_widget);
