...
GameEndInterface::GameEndInterface(QWidget *parent) : QWidget(parent)
{
    ...
    again_button->setGeometry(200, 200, 150, 100);
    game_over_button->setGeometry(200, 300, 150, 100);
...
void GameEndInterface::get_end_type(int type)
{
    ...
    game_over_label->setGeometry(400, 100, 300, 80);
    game_over_label->setStyleSheet("font: bold 45px");
    again_button->show();
