...
void LevelUpSelectInterface::prop_generate()
{
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        while (!loc[i])
        {
            ...
            {
                label1->show();
                label1->setGeometry(80 + 350 * i, 300, 200, 90);
                label1_flag = true;
                loc[i] = 1;
            }
            ...
            {
                label2->show();
                label2->setGeometry(80 + 350 * i, 300, 200, 90);
                label2_flag = true;
                loc[i] = 2;
            }
            ...
            {
                label3->show();
                label3->setGeometry(80 + 350 * i, 300, 200, 90);
                label3_flag = true;
                loc[i] = 3;
            }
            ...
            {
                label4->show();
                label4->setGeometry(80 + 350 * i, 300, 200, 90);
                label4_flag = true;
                loc[i] = 4;
            }
            ...
            {
                label5->show();
                label5->setGeometry(80 + 350 * i, 300, 200, 90);
                label5_flag = true;
                loc[i] = 5;
            }
            ...
            {
                label6->show();
                label6->setGeometry(80 + 350 * i, 300, 200, 90);
                label6_flag = true;
                loc[i] = 6;
            }
        }
