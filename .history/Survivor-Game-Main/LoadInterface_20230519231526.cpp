...
LoadInterface::LoadInterface(QWidget *parent) : QWidget(parent)
{
    ...
    save_button2->setGeometry(430, 500, 150, 80);      // 设置保存存档按钮位置
    ...
    load_button2->setGeometry(430, 600, 150, 80);      // 设置加载存档按钮位置
