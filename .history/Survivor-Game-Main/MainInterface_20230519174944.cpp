...
MainInterface::MainInterface(QWidget *parent) : QWidget(parent)
{
    ...
    continue_button->setGeometry(430, 450, 150, 80);   // 设置继续游戏按钮位置
    ...
    connect(load_button, &QPushButton::clicked, this, &MainInterface::load_date);        // 加载存档按钮连接
...
void MainInterface::startGame()
{
    ...
    enter_shop_button->setGeometry(430, 650, 150, 80);
    exitButton->setGeometry(430, 750, 150, 80);
}
