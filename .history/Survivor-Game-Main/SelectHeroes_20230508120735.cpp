...
SelectHeroesInterface::SelectHeroesInterface(QWidget *parent) : QWidget(parent)
{
    ...
    connect(select_hero1, &QPushButton::clicked, this, &SelectHeroesInterface::hero1_to_fight); // 返回按钮连接
    select_hero2 = new QPushButton("选择NOA", this);
    select_hero2->setGeometry(690, 500, 100, 30);
    connect(select_hero2, &QPushButton::clicked, this, &SelectHeroesInterface::hero2_to_fight); // 返回按钮连接
}
