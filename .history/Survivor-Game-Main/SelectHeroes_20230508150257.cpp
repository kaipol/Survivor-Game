...
SelectHeroesInterface::SelectHeroesInterface(QWidget *parent) : QWidget(parent)
{
    ...
    hero1_hp->setGeometry(210, 550, 100, 30);                                                   // 血量显示位置
    hero1_atk = new QLabel("攻击力: 5", this);                                                  // 攻击力显示
    hero1_atk->setGeometry(210, 600, 100, 30);                                                  // 攻击力显示位置
    ...
    hero2_hp->setGeometry(690, 550, 100, 30);                                                   // 血量显示位置
    hero2_atk = new QLabel("攻击力: 7", this);                                                  // 攻击力显示
    hero2_atk->setGeometry(690, 600, 100, 30);                                                  // 攻击力显示位置
}
