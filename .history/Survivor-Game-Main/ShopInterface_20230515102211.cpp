...
ShopInterface::ShopInterface(QWidget *parent) : QWidget(parent)
{
    ...
    buy_button1->setGeometry(800, 100, 100, 50);       // 设置按钮位置和大小
    buy_button2->setGeometry(800, 200, 100, 50);       // 设置按钮位置和大小
    buy_button3->setGeometry(800, 300, 100, 50);       // 设置按钮位置和大小
    ...
    connect(buy_button5, &QPushButton::clicked, this, [=]()
            { buy_event(5); }); // 按钮信号连接
    connect(back_button, &QPushButton::clicked, this, &ShopInterface::back_to_main
}; // 按钮信号连接
