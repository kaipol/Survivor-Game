...
void ShopInterface::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawPixmap(100, 100, 100, 100, "../src/Sprite/attack_potion.png");
    painter.drawPixmap(100, 200, 100, 100, "../src/Sprite/speed_potion.png");
    painter.drawPixmap(100, 300, 100, 100, "../src/Sprite/revive_potion.png");
}
