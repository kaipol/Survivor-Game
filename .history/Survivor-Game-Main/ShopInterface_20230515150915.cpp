...
void ShopInterface::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawPixmap(500, 100, 100, 100, QPixmap("../src/Sprite/attack_potion.png"));
    painter.drawPixmap(500, 200, 100, 100, QPixmap("../src/Sprite/speed_potion.png"));
    painter.drawPixmap(500, 300, 100, 100, QPixmap("../src/Sprite/revive_potion.png"));
