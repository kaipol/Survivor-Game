...
ShopInterface::ShopInterface(QWidget *parent) : QWidget(parent)
{
    ...
    buy_button1->setGeometry(500, 400, 100, 50);       // 设置按钮位置和大小
    buy_button2->setGeometry(600, 400, 100, 50);       // 设置按钮位置和大小
    buy_button3->setGeometry(700, 400, 100, 50);       // 设置按钮位置和大小
    buy_button4->setGeometry(800, 400, 100, 50);       // 设置按钮位置和大小
    buy_button5->setGeometry(800, 500, 100, 50);       // 设置按钮位置和大小
...
void ShopInterface::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawPixmap(400, 100, 150, 150, QPixmap("../src/Sprite/attack_potion.png"));
    painter.drawPixmap(500, 100, 150, 150, QPixmap("../src/Sprite/speed_potion.png"));
    painter.drawPixmap(700, 300, 100, 100, QPixmap("../src/Sprite/revival_potion.png"));
    painter.drawPixmap(500, 400, 100, 100, QPixmap("../src/Sprite/coin_potion.png"));
    painter.drawPixmap(500, 500, 100, 100, QPixmap("../src/Sprite/hp_potion.png"));
}
