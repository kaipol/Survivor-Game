...
ShopInterface::ShopInterface(QWidget *parent) : QWidget(parent)
{
    ...
    buy_button1->setGeometry(450, 350, 100, 50);       // 设置按钮位置和大小
    buy_button2->setGeometry(650, 350, 100, 50);       // 设置按钮位置和大小
    buy_button3->setGeometry(850, 350, 100, 50);       // 设置按钮位置和大小
    buy_button4->setGeometry(550, 550, 100, 50);       // 设置按钮位置和大小
    buy_button5->setGeometry(750, 550, 100, 50);       // 设置按钮位置和大小
