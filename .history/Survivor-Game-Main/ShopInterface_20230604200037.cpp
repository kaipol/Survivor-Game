...
ShopInterface::ShopInterface(QWidget *parent) : QWidget(parent)
{
    ...
    prop1_label->setGeometry(400, 100, 100, 30);               // 设置标签位置和大小
    prop1_label->setStyleSheet("font:bold 20px; color:black"); // 设置标签样式
    prop2_label = new QLabel(prop2->get_name(), this);         // 创建标签
    prop2_label->setGeometry(600, 100, 100, 50);               // 设置标签位置和大小
    prop2_label->setStyleSheet("font:bold 20px; color:black"); // 设置标签样式
    prop3_label = new QLabel(prop3->get_name(), this);         // 创建标签
    prop3_label->setGeometry(800, 100, 100, 50);               // 设置标签位置和大小
    prop3_label->setStyleSheet("font:bold 20px; color:black"); // 设置标签样式
    prop4_label = new QLabel(prop4->get_name(), this);         // 创建标签
    prop4_label->setGeometry(500, 250, 100, 50);               // 设置标签位置和大小
    prop4_label->setStyleSheet("font:bold 20px; color:black"); // 设置标签样式
    prop5_label = new QLabel(prop5->get_name(), this);         // 创建标签
    prop5_label->setGeometry(700, 250, 100, 50);               // 设置标签位置和大小
    prop5_label->setStyleSheet("font:bold 20px; color:black"); // 设置标签样式
    prop1_info = new QLabel(prop1->get_info(), this);          // 创建标签
    prop1_info->setGeometry(400, 150, 100, 50);                // 设置标签位置和大小
    prop1_info->setStyleSheet("font:bold 20px; color:black");  // 设置标签样式
    prop2_info = new QLabel(prop2->get_info(), this);          // 创建标签
    prop2_info->setGeometry(600, 150, 100, 50);                // 设置标签位置和大小
    prop2_info->setStyleSheet("font:bold 20px; color:black");  // 设置标签样式
    prop3_info = new QLabel(prop3->get_info(), this);          // 创建标签
    prop3_info->setGeometry(800, 150, 100, 50);                // 设置标签位置和大小
    prop3_info->setStyleSheet("font:bold 20px; color:black");  // 设置标签样式
    prop4_info = new QLabel(prop4->get_info(), this);          // 创建标签
    prop4_info->setGeometry(500, 300, 100, 50);                // 设置标签位置和大小
    prop4_info->setStyleSheet("font:bold 20px; color:black");  // 设置标签样式
    prop5_info = new QLabel(prop5->get_info(), this);          // 创建标签
    prop5_info->setGeometry(700, 300, 100, 50);                // 设置标签位置和大小
    prop5_info->setStyleSheet("font:bold 20px; color:black");  // 设置标签样式
