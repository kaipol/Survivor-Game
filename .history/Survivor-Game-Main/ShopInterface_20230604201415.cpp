...
ShopInterface::ShopInterface(QWidget *parent) : QWidget(parent)
{
    ...
    prop1_label->setGeometry(430, 120, 100, 30);               // 设置标签位置和大小
    ...
    prop2_label->setGeometry(630, 120, 100, 30);               // 设置标签位置和大小
    ...
    prop3_label->setGeometry(800, 120, 100, 30);               // 设置标签位置和大小
    ...
    prop4_label->setGeometry(500, 270, 100, 30);               // 设置标签位置和大小
    ...
    prop5_label->setGeometry(700, 270, 100, 30);               // 设置标签位置和大小
