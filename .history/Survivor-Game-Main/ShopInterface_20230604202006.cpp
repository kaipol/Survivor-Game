...
ShopInterface::ShopInterface(QWidget *parent) : QWidget(parent)
{
    ...
    prop1_label->setGeometry(430, 130, 100, 30);               // 设置标签位置和大小
    ...
    prop2_label->setGeometry(630, 130, 100, 30);               // 设置标签位置和大小
    ...
    prop3_label->setGeometry(800, 130, 100, 30);               // 设置标签位置和大小
