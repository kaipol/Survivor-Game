...
ShopInterface::ShopInterface(QWidget *parent) : QWidget(parent)
{
    ...
    prop1_info->setGeometry(430, 150, 100, 50);                                  // 设置标签位置和大小
    ...
    prop1_cost->setGeometry(440, 200, 100, 30);                                  // 设置标签位置和大小
    ...
    prop2_info->setGeometry(630, 150, 100, 50);                                  // 设置标签位置和大小
    ...
    prop2_cost->setGeometry(630, 200, 100, 30);                                  // 设置标签位置和大小
    ...
    prop3_info->setGeometry(800, 150, 100, 50);                                  // 设置标签位置和大小
    ...
    prop3_cost->setGeometry(810, 200, 100, 30);                                  // 设置标签位置和大小
    ...
    prop4_info->setGeometry(500, 450, 200, 50);                                  // 设置标签位置和大小
    ...
    prop4_cost->setGeometry(550, 500, 100, 30);                                  // 设置标签位置和大小
