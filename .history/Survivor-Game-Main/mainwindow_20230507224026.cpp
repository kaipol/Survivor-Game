    ...
    : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    main_interface->setFixedSize(1000, 900);
    select_heroes_interface->setFixedSize(1000, 900);
    ...
    connect(main_interface, &MainInterface::changeWidgetsignal, this, &MainWindow::changeWidget);
    connect(select_heroes_interface, &SelectHeroesInterface::changeWidgetsignal, this, &MainWindow::changeWidget);
}
