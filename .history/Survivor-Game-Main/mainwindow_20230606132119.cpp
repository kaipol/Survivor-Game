    ...
    : QMainWindow(parent), ui(new Ui::MainWindow)
{
    ...
    connect(game_end_interface, &GameEndInterface::changeWidgetsignal, this, &MainWindow::changeWidget);              // 切换窗口信号连接
    connect(level_up_select_interface, &LevelUpSelectInterface::changeWidgetsignal, this, &MainWindow::changeWidget); // 切换窗口信号连接
    ...
    connect(fight_interface, &FightInterface::now_coin, shop_interface, &ShopInterface::get_coin);                  // 金币信号连接
    connect(shop_interface, &ShopInterface::now_coin, fight_interface, &FightInterface::get_coin);                  // 金币信号连接
    ...
    connect(fight_interface, &FightInterface::hero_level_up_signal, level_up_select_interface, &LevelUpSelectInterface::prop_generate); // 英雄升级信号连接
    ...
    connect(fight_interface, &FightInterface::save_data_signal, load_interface, &LoadInterface::get_save_date); // 保存存档信号连接
    connect(fight_interface, &FightInterface::now_map_type, load_interface, &LoadInterface::get_map_type);      // 保存存档信号连接
    ...
    connect(game_end_interface, &GameEndInterface::restart_game_signal, select_heroes_interface, &SelectHeroesInterface::restart_select); // 重新开始信号连接
    connect(game_end_interface, &GameEndInterface::restart_game_signal, this, &MainWindow::restart_game);                                 // 重新开始信号连接
